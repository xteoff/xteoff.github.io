    ...
    let slidesJsx = slides.map(function (sl,i){
        return(
            <Slide className="gap-10">
                <Card img1="media/Swan/палетка.webp" img2="media/Swan/палетка_от.svg" text="6-Color Eyeshadow Palette" price="₽ 3 200"/>
            </Slide>
        )
    });
    ...
    return(
        <>
            <div className="flex justify-center h-fit pb-5">
                <img src="media/Swan_banner.svg" alt="" />
            </div>
            <Slider {...settings}>
                    {slidesJsx}
            </Slider>
