...
function BannerMermaid(){

    let slidesJsx = slides.map(function (sl,i){
        return(
            <Slide className="gap-10">
                <Card img1="media/Mermaid/палетка.jpg" img2="media/Mermaid/палетка_от.svg" text="5-Color Eyeshadow Palette" price="₽ 3 400"/>
            </Slide>
        )
    });
    ...
    return(
        <>
            <div className="flex justify-center h-fit pb-5">
                <img src="media/Mermaid_banner.svg" alt="" />
            </div>
            <Slider {...settings}>
                    {slidesJsx}
            </Slider>
